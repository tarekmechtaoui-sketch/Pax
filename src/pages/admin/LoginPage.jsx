    ...
    <div className="min-h-screen bg-cream dark:bg-charcoal-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <img src="/logo.png" alt="pax" className="h-14 w-auto mx-auto mb-4" />
          <h1 className="text-2xl font-black text-charcoal dark:text-white">pax Admin</h1>
        ...
        <p className="text-center text-xs text-charcoal-400 mt-6">
          pax Admin Panel — Authorized Access Only
        </p>
      </div>
    </div>
  )
